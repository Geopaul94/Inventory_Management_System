...
// // // Placeholder for Items Report Tab
// import 'dart:io';
...
// class ItemsReportTab extends StatelessWidget {
...
//               onPressed: () async {
//                 try {
//                   PdfGeneratorItemreport pdfGenerator =
//                       PdfGeneratorItemreport();
...
//       List<Products> salesDetails = querySnapshot.docs.map((doc) {
...
//       Map<String, double> totalPurchasedQuantity = {};
//       Map<String, int> totalSoldQuantity = {};
